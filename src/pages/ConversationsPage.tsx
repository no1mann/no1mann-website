    ...
    <div>
      ...
      <div className="space-y-10">
        {conversations.map((item) => (
          <article key={item.title} className="group border-b border-foreground/10 pb-8 last:border-0">
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:gap-12">
              ...
              <div className="flex-1">
                <h3 className="mb-2 font-heading text-xl font-bold leading-tight transition-colors group-hover:text-primary md:text-2xl">
                  {item.title}
                </h3>
